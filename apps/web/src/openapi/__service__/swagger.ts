...
export const getOpenApi = () => {
  ...
  const updatePet = (pet: Pet) => {
    return x<Pet>({ url: `/pet`, method: 'PUT', headers: { 'Content-Type': 'application/json' }, data: pet });
  };
  ...
  const addPet = (pet: Pet) => {
    return x<Pet>({ url: `/pet`, method: 'POST', headers: { 'Content-Type': 'application/json' }, data: pet });
  };
  ...
  const findPetsByStatus = (params?: FindPetsByStatusParams) => {
    return x<Pet[]>({ url: `/pet/findByStatus`, method: 'GET', params });
  };
  ...
  const findPetsByTags = (params?: FindPetsByTagsParams) => {
    return x<Pet[]>({ url: `/pet/findByTags`, method: 'GET', params });
  };
  ...
  const getPetById = (petId: number) => {
    return x<Pet>({ url: `/pet/${petId}`, method: 'GET' });
  };

  /**
   * @summary Updates a pet in the store with form data
   */
  const updatePetWithForm = (petId: number, params?: UpdatePetWithFormParams) => {
    return x<unknown>({ url: `/pet/${petId}`, method: 'POST', params });
  };
  ...
  const deletePet = (petId: number) => {
    return x<unknown>({ url: `/pet/${petId}`, method: 'DELETE' });
  };

  /**
   * @summary uploads an image
   */
  const uploadFile = (petId: number, uploadFilePayload: Blob, params?: UploadFileParams) => {
    return x<ApiResponse>({ url: `/pet/${petId}/uploadImage`, method: 'POST', headers: { 'Content-Type': 'application/octet-stream' }, data: uploadFilePayload, params });
  };
   ...
   */
  const getInventory = () => {
    return x<GetInventory200>({ url: `/store/inventory`, method: 'GET' });
  };
  ...
  const placeOrder = (order: Order) => {
    return x<Order>({ url: `/store/order`, method: 'POST', headers: { 'Content-Type': 'application/json' }, data: order });
  };
  ...
  const getOrderById = (orderId: number) => {
    return x<Order>({ url: `/store/order/${orderId}`, method: 'GET' });
  };
  ...
  const deleteOrder = (orderId: number) => {
    return x<unknown>({ url: `/store/order/${orderId}`, method: 'DELETE' });
  };
  ...
  const createUser = (user: User) => {
    return x<User>({ url: `/user`, method: 'POST', headers: { 'Content-Type': 'application/json' }, data: user });
  };
  ...
  const createUsersWithListInput = (user: User[]) => {
    return x<User>({ url: `/user/createWithList`, method: 'POST', headers: { 'Content-Type': 'application/json' }, data: user });
  };
  ...
  const loginUser = (params?: LoginUserParams) => {
    return x<string>({ url: `/user/login`, method: 'GET', params });
  };
   ...
   */
  const logoutUser = () => {
    return x<void>({ url: `/user/logout`, method: 'GET' });
  };
  ...
  const getUserByName = (username: string) => {
    return x<User>({ url: `/user/${username}`, method: 'GET' });
  };
  ...
  const updateUser = (username: string, user: User) => {
    return x<void>({ url: `/user/${username}`, method: 'PUT', headers: { 'Content-Type': 'application/json' }, data: user });
  };
  ...
  const deleteUser = (username: string) => {
    return x<unknown>({ url: `/user/${username}`, method: 'DELETE' });
  };
