...
import type { ApiResponse, GetInventory200, Order, Pet, User } from './swagger.schemas';
...
export const getUpdatePetResponseMock = (overrideResponse: any = {}): Pet => ({
  ...
  status: faker.helpers.arrayElement([faker.helpers.arrayElement(['available', 'pending', 'sold'] as const), undefined]),
...
export const getPlaceOrderResponseMock = (overrideResponse: any = {}): Order => ({
  ...
  status: faker.helpers.arrayElement([faker.helpers.arrayElement(['placed', 'approved', 'delivered'] as const), undefined]),
  ...overrideResponse,
});
